        ...
        >
            <div className="navbar-inner">
                ...
                <nav className="navbar-links" aria-label="Navegação principal">
                    ...
                    <button onClick={() => window.open('https://wa.me/5551981951175', '_blank')} className="navbar-cta">
                        Falar com a VOY
                    </button>
                </nav>
            ...
            >
                ...
                <button onClick={() => window.open('https://wa.me/5551981951175', '_blank')} className="navbar-mobile-cta">
                    Falar com a VOY
                </button>
            </div>
        </header>
